                        ...
                        <table class="table table-striped table-sm">
                            ...
                            if ($result->rowCount() > 0) {
                                ...
                                while($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                    $cv_link = $row["CV"] ? "<a href='view_cv.php?id=" . $row["ID_Medecin"] . "'>Voir CV</a>" : "Pas de CV";
                                    echo "<tr class='clickable-row'>
                                            ...
                                            <td>
                                                ...
                                                <button class='btn btn-secondary' onclick='location.href='cv_medecin.php''><i class='fa fa-file-alt'></i> Ajouter un CV</button>
                                            </td>
                                          </tr>";
                                }
                            } else {
